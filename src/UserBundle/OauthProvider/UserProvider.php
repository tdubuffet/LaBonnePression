...
class UserProvider extends BaseFOSUBProvider
{
    ...
    public function loadUserByOAuthUserResponse(UserResponseInterface $response)
    {
        ...
        $user = $this->doctrine->getRepository('UserBundle:Account')->findOneBy(array($this->getProperty($response) => $username));
        ...
        if (null === $user) {
            ...
            if ($userValue != null) {
                ...
                do {
                    ...
                    $userValue = $this->doctrine->getRepository('UserBundle:Account')->findOneBy(array('username' => $newNickname));
                    $i++;
